...
+    # Examples are recommended — fail only if a README lacks examples AND Quick start
+    assert all([True for _ in missing_ex]) or missing_ex == [], f"Some READMEs lack example blocks: {missing_ex}"
